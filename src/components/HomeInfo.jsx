...
//   Hi, my name is <span className="font-semibold">Nguyen Duc Huy</span>.
...
const renderContent = {
  1: (
    <div className="info-box">
      ...
      <a
        href="https://drive.google.com/file/d/1sl5GPO88DfL2QrireZFAKWwpNAdmRtMi/view?usp=drive_link"
        alt="resume"
        target="_blank"
